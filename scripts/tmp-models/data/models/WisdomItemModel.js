...
var WisdomItemModel = function () {
    ...
    return _a = /** @class */ (function (_super) {
            __extends(WisdomItemModel, _super);
            function WisdomItemModel() {
                ...
                _this.category = (__runInitializers(_this, _content_extraInitializers), __runInitializers(_this, _category_initializers, void 0));
                _this.tags = (__runInitializers(_this, _category_extraInitializers), __runInitializers(_this, _tags_initializers, void 0));
                _this.createdAt = (__runInitializers(_this, _tags_extraInitializers), __runInitializers(_this, _createdAt_initializers, void 0));
            ...
            return WisdomItemModel;
        }(_classSuper)),
        (function () {
            var _b;
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create((_b = _classSuper[Symbol.metadata]) !== null && _b !== void 0 ? _b : null) : void 0;
            _title_decorators = [(0, decorators_1.field)('title')];
            _content_decorators = [(0, decorators_1.field)('content')];
            _category_decorators = [(0, decorators_1.field)('category')];
            _tags_decorators = [(0, decorators_1.field)('tags')];
        ...
        _a.table = 'wisdom_items',
        _a;
}();
exports.default = WisdomItemModel;
